                    ...
                    <tr>
                        <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
                            <a href="https://pifs.lts.com.fj" target="_blank">
                                <img alt="Logo" src="https://pifs.lts.com.fj/LTS-logo.jpg" width="100"
                                    height="100"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 32px; font-weight: 400; margin: 0;">Your GLOBAL HR Account Is Ready
                            </h1>
                        </td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#7c72dc"><a
                                                        href={{ $resetUrl }} target="_blank"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #e1e6f1;; text-decoration: none; color: #e1e6f1;; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #7c72dc; display: inline-block;">Reset
                                                        Password</a></td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    ...
                    <tr>
                        <td bgcolor="#f4f4f4" align="left"
                            ...
                            <p style="margin: 0;">You received this email because your account has been created on
                                GLOBAL HR.</p>
                        </td>
                    </tr>
                    <!-- ADDRESS -->
