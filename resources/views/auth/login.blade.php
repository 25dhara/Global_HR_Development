        ...
        <div class="offcanvas-body">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="d-flex justify-content-center gap-1 canvas-footer flex-wrap align-items-center">
                    ...
                    <a href="https://themeforest.net/user/spruko/portfolio" class="btn btn-secondary">Our
                        Portfolio</a>
                    ...
                    <div class="row row-sm">
                        <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
                            <div class="mt-5 pt-4 p-2 position-absolute">
                                ...
                                <span class="text-white-6 fs-13 mb-5 mt-xl-0">Welcome to Global HR Portal</span>
                            </div>
                        </div>
